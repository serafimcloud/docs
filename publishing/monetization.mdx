...
- The platform membership plan (the "supporters" count shown on [21st.dev/pricing](https://21st.dev/pricing)) is about supporting 21st.dev itself, not a way to receive money as an individual author — use the **Donation** block for that.
