...
<Warning>
  ...
  **Buy / download URL**; a visitor who clicks buy sees a disclaimer confirming
  ...
  for delivery, receipts, and refunds.

  Buying on 21st.dev — card checkout here, instant download, no redirect —
  exists for a small number of listings released one at a time, and is not open
  for self‑serve publishing yet. Write to support@21st.dev if you'd like your
  template considered.
</Warning>
