...
optional video in the background. Video is best-effort: publishing never waits
for it and includes it only if it is ready; the cover is required. Replace
either generated asset manually before publishing.
