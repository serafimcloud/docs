...
<AccordionGroup>
  <Accordion title="Do I need to pay to use 21st?">
    No. Browsing and searching the Marketplace is always free. Without a paid
    plan you get **2 free component copies per day** and **2 marketplace
    searches per day** via the CLI/MCP, plus **30 free 21st AI credits per
    month** for generation. A [Membership](/ai/pricing) or any paid 21st AI
    plan removes the daily marketplace limits.
  </Accordion>

  <Accordion title="What's the difference between Membership and a 21st AI plan?">
    **Membership** unlocks unlimited Marketplace access — copying component
    code and searching via CLI/MCP with no daily cap. A paid **21st AI plan**
    (Community or Pro) bundles Membership-level marketplace access together
    with monthly generation credits, so you don't need both separately. See
