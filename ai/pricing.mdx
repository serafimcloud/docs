...
Browsing and searching the marketplace is free. **21st AI generation** runs on **credits** — included with a paid plan, or bought as a credit pack on any plan. The free Hobby tier has no monthly generation credits.
...
21st AI generation is a paid feature. Paid plans include monthly credits, the 4-model Sketch comparison, and Code mode, and unlock the whole marketplace. On the free Hobby tier, browsing and search are free but generation needs credits (a paid plan, or a credit pack).
...
<CardGroup cols={3}>
  <Card title="Hobby" icon="/icons/nav/gift.svg">
    **Free forever.** Full marketplace browsing, unlimited UI inspirations, and
    ...
    included — add it with a paid plan or a credit pack.
  </Card>
