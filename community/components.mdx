...
- [21st AI](/ai) to generate variations
- Cursor, Claude, or ChatGPT for customization
- Any AI coding tool (directly, or via [MCP](/ai/mcp))
...
<Card title="All Shortcuts" icon="/icons/nav/keyboard.svg" href="/community/keyboard-shortcuts">
