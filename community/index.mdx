...
The 21st Marketplace is where developers share high-quality React and Tailwind CSS work. Most components are **open-source under the MIT license**, and every component page shows the license that component actually carries, so check it before you ship. A component indexed from an open-source project also links to that project's own license file and copyright notice.
