...
When working with a connected repository, branches are local by default and only
published to GitHub when you open a PR. For a full overview of how to get your
code (PRs, Git patches, downloads for empty projects), see
[Getting Your Code](/canvas/getting-code).

<Warning>
21st never commits directly to your repository. Branches stay local until you
explicitly open a PR — you always control when changes are published and
integrated.
</Warning>
