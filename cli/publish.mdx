...
<Info>
Publishing a new **private** component to your personal scope requires Builder
with AI enabled.
Private publishing to a team scope requires an active Team plan and owner or
admin access. Existing private personal components remain private if you are on
another plan.
</Info>
...
Changing an existing personal component from published to private requires
Builder with AI enabled.
Editing an already-private component does not make it public.
