...
| Command                                                     | Description                                                                                                                 |
| ----------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| `21st publish <file> --description "…"`                     | Build a new component, open its Studio draft for preview/cover review, then publish; update an owned existing slug directly |
...
<Warning>
  Component publishing accepts a login session or secret API key. Theme/template
  publishing and management commands require a `21st_sk_…` key. See [Publish &
  manage](/cli/publish).
</Warning>
