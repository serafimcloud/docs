...
Requires AI enabled on your account and available [credits](/ai/pricing).
Check AI access with `21st usage` before generating. CLI 1.17.1 also supports
`21st usage --json`, whose `aiGenerationEnabled` field reports this access.
