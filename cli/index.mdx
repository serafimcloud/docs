...
<CardGroup cols={2}>
  ...
  <Card title="Generate with 21st AI" icon="/icons/nav/magic-chat.svg" href="/cli/generate">
    Start a generation, list its drafts, refine a take, and grab the code.
  </Card>
  <Card title="Publish & manage" icon="/icons/nav/publish.svg" href="/cli/publish">
  ...
  <Card title="Editor & MCP setup" icon="/icons/nav/cable.svg" href="/cli/setup">
    Wire the 21st MCP into Cursor, Claude, VS Code, and install the skills.
  </Card>
  <Card title="Command reference" icon="/icons/nav/terminal.svg" href="/cli/reference">
